...
OBJS = $(BUILD_DIR)/main.o $(BUILD_DIR)/init.o $(BUILD_DIR)/interrupt.o \
	  ...
	  $(BUILD_DIR)/fork.o  $(BUILD_DIR)/shell.o $(BUILD_DIR)/assert.o $(BUILD_DIR)/buildin_cmd.o \
	  $(BUILD_DIR)/exec.o $(BUILD_DIR)/wait_exit.o $(BUILD_DIR)/pipe.o 
##############     c代码编译     ###############
$(BUILD_DIR)/main.o: kernel/main.c lib/kernel/print.h \
        lib/stdint.h kernel/init.h kernel/debug.h kernel/memory.h
	$(CC) $(CFLAGS) $< -o $@
...
$(BUILD_DIR)/keyboard.o: device/keyboard.c device/keyboard.h lib/kernel/print.h kernel/interrupt.h \
...
hd:
	dd if=$(BUILD_DIR)/kernel.bin \
           of=hd60M.img \
           bs=512 count=300 seek=9 conv=notrunc
